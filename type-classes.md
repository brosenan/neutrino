...
```error
Type mismatch. Expression case (Index::int64==0)of{true=>case next(Seq::unknown_type12)of{just((First::int64,_::unknown_type12))=>just(First::int64+1);none=>none};false=>case next(Seq::unknown_type12)of{just((_::_4566,Next::unknown_type12))=>nth(Next::unknown_type12,Index::int64-1);none=>none}} expected to be maybe(unknown_type13), inferred: maybe(int64).
```
